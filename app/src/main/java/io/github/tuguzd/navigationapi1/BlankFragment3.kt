package io.github.tuguzd.navigationapi1
...
import io.github.tuguzd.navigationapi1.databinding.FragmentBlank3Binding
...
class BlankFragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        findNavController().previousBackStackEntry?.
            savedStateHandle?.set("result_from_activity", "ответные данные")
